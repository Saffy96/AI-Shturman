...
export function RouteSummary({ route, stationCount }: { route: RouteFuelResponse; stationCount: number }) {
  ...
  return <section className="sticky top-2 z-30 overflow-hidden rounded-[28px] border border-white/70 bg-white/90 p-4 shadow-[0_20px_60px_rgba(15,23,42,.12)] backdrop-blur-xl">
